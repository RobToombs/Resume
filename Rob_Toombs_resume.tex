...
\textbf{Tech:} Claude Code, Docker, Spring, Hibernate, GraphQL, Puppeteer/Cucumber, AWS (Lambda, Fargate, ALB/NLB, Route 53, Cognito, DynamoDB, SQS/SNS, S3, Step Functions, CloudFormation, CDK)  \\
...
\vspace{-9pt}
\begin{itemize}
  \item Heavily leveraging Claude Code for daily tasks from code language migrations, automating enterprise tech backlog cleanup, increasing test quality and coverage, tracking daily work done and automating JIRA documenation
  \item Assisted Island.io engineers in creating and maintaining connectors between Island Browser and Capital One resources for Kohl's servicing agents for a Partnership-as-a-Service (PaaS) implementation
  \item Worked across multiple teams to develop a AWS Step Function, Lambda, and DynamoDB based auditing solution, handling millions of daily requests, providing real time information on outbound customer collections calls
...
\textbf{Software Engineer,} \href{https://www.fstl1992.com/}{Goodrich ISR Systems (now UTC Aerospace Systems)} -- Westford, MA \hfill 2011 -- 2012 \\
\vspace{-9pt}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \section*{Projects}
 \begin{itemize}
    \item \textbf{rob-toombs.com:} My constantly evolving "tech sandbox" site consisting of a Svelte/Typescript SPA hosted in S3, distributed through CloudFront, with OAuth 2.0 integration using AWS Cognito, and API Gateway providing secured access to a Go Lambda backend questionnaire engine. The backend stack is nearly fully managed through python CDK deployments, with separate Dev/Prod environments in development and eyes on future CodePipeline integration.
...
\textbf{AWS Certified Developer Associate} -- 83fd42ea-c3f2-4301-8ed3-75fb1c39f2e5 \hfill 2023 -- 2026 \\
\textbf{AWS Certified AI Practitioner} -- 9cc11c94-7fd4-41aa-96bf-57d9e17e3481 \hfill 2026 -- 2029
