...
\begin{itemize}
  ...
  \item Worked across multiple teams to develop a AWS Step Function, Lambda, and DynamoDB based auditing solution for providing real time information on outbound customer collections calls
