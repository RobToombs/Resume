...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \begin{itemize}
   ...
   \item \textbf{rob-toombs.com:} My "tech sandbox" site consisting of a Svelte/Typescript SPA hosted in S3, distributed through CloudFront, with OAuth 2.0 integration using AWS Cognito, and API Gateway providing secured access to a Go Lambda backend questionnaire engine
 \end{itemize}
